...
I present a framework which is able to choose any one of these transformations.
...
This was neglected by Jacobi at first, but it was evenutally shown by Perron.
Since then, the main focus has been on the second part again
...
which strongly suggest that every cubic irrational has a periodic MCF.
The aim of this analysis was to evaluate different strategies
for constructing periodic MCFs for algebraic numbers.
One of these strategy shows particular promise in the construction,
