...
A number is represented as a sequence of digits,
where the integer part is separated from the (potentially infinite) fractional part.
Using this representation,
we can easily check if a number is rational or not.
If the decimal expansion of a number is finite, then the number is clearly rational.
However, the number is also rational if the fractional part is eventually periodic.
Continued fractions extend this to roots of quadratic polynomials, also
called quadratic irrationals.
They are fractions of the form
\[
  a₀ + \cfrac{1}{a₁ + \cfrac{1}{a₂ + \cfrac{1}{⋱}}},
\]
where $a₀, a₁, a₂, …$ are integers.
Every number can be represented as a continued fraction
and if that continued fraction is periodic, then the number must be a quadratic irrational.
...
Despite the existence of these periodic representations for rational and
irrational numbers, there exists no periodic representation for cubic
irrationals.

This was originally asked by Charles Hermite,
who in 1839 wrote a letter to Jacobi~\cite{Hermite50} about the
...
Such a representation would not only be useful for its algebraic properties,
...
% ==============================================================================
\section{The Jacobi-Perron Algorithm}
% ==============================================================================
