...
When calculating a new convergent, we replace only one of the secondary convergents.
The second requirement guarantees that we always move every convergent
