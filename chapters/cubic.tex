...
The multi-dimensional extension of the continued fractions is based on the update rule.
Recall that given a vector $x ∈ ℝ^d$ and index $ℓ ≤ d$, we update the input vector over one iteration by
\[
  \begin{array}{lcrlcr}
