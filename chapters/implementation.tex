...
The second part of this chapter focuses on the approximation rate of MCFs.
...
Here, we test whether MCFs offer similar approximation behavior in higher dimensions.
...
The idea would be that the convergents of MCFs are such good rational approximations.
To study this behavior, I did a brief analysis on the number of convergents,
which satisfy this bound.

The implementation consists of a breadth-first search over the construction of an MCF for the vector $x$.
...
However, they are notably different MCFs than those found in the brute-force
search.
So some cubic roots can have different MCFs
