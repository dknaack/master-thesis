...
This multiplication matrix actually has the power basis as a \emph{left} eigenvector.
The other eigenvectors are similarly the power basis of the conjugates of $α$,
that is any root $α_i$ of $m_α(x)$ defines another left eigenvector $(1, α_i, …, α_i^{n-1})$.
...
\begin{proof}
  ...
  Although the eigenvector of Lemma~\ref{lem:mult-eig} is on the left,
