...
The main goal of this chapter is to show that the continued fractions of a
number are periodic if and only if the number is a quadratic irrational.
For the proof, we require many important properties for continued fractions.
...
which was initially proposed by Klein~\cite{Klein95}.
In his interpretation, he viewed the continued fractions as points in a two-dimensional lattice.
Using his interpretation,
we show that any quadratic irrational has a periodic continued fraction.

% ==============================================================================
\section{Definition and Basic Properties}
% ==============================================================================

We begin with a precise definition of continued fractions,
focusing especially on infinite continued fractions.
...
\begin{definition}
  ...
  \]
  exists.
  The continued fraction $[r₀; r₁, …, rₖ]$ is also called the \emph{$k$-th convergent} of $[r₀; r₁, …, r_n]$.
\end{definition}

% TODO: Definition is one-way, but the following lemma is the other way
...
For a continued fraction $[a₀; a₁, …]$ with integers,
we denote each convergent $[a₀; a₁, …, aₙ]$ by a unique rational value $p/q$,
which is called the \emph{canonical representation} of the convergent.
...
Lemma~\ref{lem:cf-det} already gives us a hint towards the convergence of continued fractions,
