...
\section{Continued Fractions and their Construction using the Euclidean Algorithm}
...
\begin{definition}
  Given a sequence $\{r_n\}_{n ∈ ℕ}$ of real numbers, the finite continued
...
we use the real extension of the Euclidean algorithm.
In the extension, we had two steps: First calculating the fractional value and second inverting the result.
The definition of $[r₀; r₁, …, rₙ]$ can similarly be split into two steps.
The first is an inversion of $[r₁, …, rₙ]$ and the second is an addition of $r₀$ to the result.
If we are given a continued fraction $[a₀; a₁, …, aₙ]$ with only integers,
then the integer part of it is exactly $a₀$, since $[a₁, …, aₙ]$ is greater than $1$.
So the Euclidean algorithm removes $a₀$ from the continued fraction.
Afterwards, we perform an exchange of the numerator with the denominator
...
% ==============================================================================
\section{Periodic Continued Fractions are Quadratic Irrationals}
% ==============================================================================
...
% ==============================================================================
\section{The Continued Fractions of Quadratic Irrationals are Periodic}
% ==============================================================================
