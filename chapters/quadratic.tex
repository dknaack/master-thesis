...
who showed that such continued fractions must be quadratic irrationals.
Later, Lagrange~\cite{Lagrange70} proved the other direction, that
...
Thus, the canoncial representation is unique.
