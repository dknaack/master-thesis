...
\begin{proof}
  For the first two convergents $b_{-2}$ and $b_{-1}$, there are no other
  nonzero integer points which have at least one smaller coordinate.
  Therefore, they are relative minima.
  ...
  Suppose there is a point which lies closer than $b_{n+1}$.
  There are two cases where the point may end up.

  Case 1: The point lies to the right of $(x, 1)$.
...
\begin{definition}
  ...
  \]
  The boundary of the polygon is denoted as $Π(K)$.
\end{definition}

The even and odd convergent vectors are part of two such Klein polygons.
The even convergents are part of the Klein polygon spanned by $(0, 1)$ and $(x, 1)$,
and the odd convergents are part of the Klein polygon spanned by $(x, 1)$ and $(1, 0)$.
An immediate consequence of the previous two theorems is the following:

\begin{corollary}
  Every convergent vector is an extreme point in the Klein polygon spanned by the
  vectors $(0, 1)$ and $(x, 1)$ or by the vectors $(x, 1)$ and $(1, 0)$, and
  vice-versa.
\end{corollary}
