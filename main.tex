...
\UzLThesisSetup{
  ...
  Abstract              = {
    ...
    algebraic numbers.
    Previous work has focused on a individual algorithms,
    which find a periodic representation for any cubic irrational.
    In contrast, this thesis considers a broader class of multidimensional
    continued fractions,
    which are based on a generalization of the Euclidean algorithm.

    It is shown that a subset of these multidimensional continued fractions converge,
    and that all periodic multidimensional continued fractions lead to an algebraic number.
    These results establish one direction of Hermite’s question in higher dimensions.
