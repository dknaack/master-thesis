  ...
  \begin{columns}
    ...
    \begin{center}
      \begin{tikzpicture}
        ...
        {
          c   & =  & \symbfit{\color{purple}b} \floor{x} &+& \symbfit{\color{blue}r} \\
          \symbfit{\color{purple}b}   & =  & \symbfit{\color{blue}r} \floor{x'} &+& r' \\
        };

        \draw[->, blue, in=90, out=270] ([xshift=-3mm]M-1-5.south) to ([xshift=-3mm]M-2-3.north);
    ...
    \begin{center}
      \begin{tikzpicture}
        ...
        \draw[->, blue, in=90, out=270, looseness=0.5] ([xshift=-3mm]M-1-13.south) to ([xshift=-3mm]M-2-7.north);
